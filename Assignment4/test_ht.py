...
class testing_heaps(unittest.TestCase):
	...
	def splitit(self, first, second):
		...
		while True:
			...
			character = s.readline()
			if not character:
				break
			second += (character.split())
		f.close()
		s.close()
		return first == second
	...
	def test_lin_completetest_input2(self):
		...
		ht = HashTableLinPr()
		ht.read_file("input2.txt", stop)
		ht.save_concordance("concord2-result.txt")
		self.files_differ("concord2-result.txt","concord2.txt")
	...
	def test_lin_completetest_black(self):
		...
		ht.save_concordance("concord-black-result.txt")
		self.files_differ("concord-black.txt","concord-black-result.txt")
	...
	def test_split(self): 
		...
		ht = HashTableLinPr()
		ht.read_file("input1.txt", stop)
		ht.save_concordance("testinput1")
		
		self.assertTrue(self.splitit("testinput1", "concord1-result.txt"))
	# def test_completetest_oohpapa(self):
	# 	stop = HashTableLinPr()
	# 	stop.read_stop("stop_words.txt")
	# 	ht = HashTableLinPr()
	# 	ht.read_file("oohpapa.txt", stop)
	# 	ht.save_concordance("concord-oohpapa-result.txt")
	# 	self.files_differ("concord-oohpapa.txt","concord-oohpapa-result.txt")
